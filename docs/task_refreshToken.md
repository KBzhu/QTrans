...
**文件**: `qtrans-frontend/src/utils/request.ts`
...
| `qtrans-frontend/src/utils/request.ts` | MODIFIED |
| `qtrans-frontend/src/composables/useLogin.ts` | MODIFIED |
...
4. **请求头字段**: 使用 `token` 字段，非标准 `Authorization: Bearer`
